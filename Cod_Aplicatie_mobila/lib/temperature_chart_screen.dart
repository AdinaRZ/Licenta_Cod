...
enum TemperatureViewType { day, week, month }
...
class _TemperatureChartScreenState extends State<TemperatureChartScreen> {
  ...
  TemperatureViewType selectedView = TemperatureViewType.day;
  String? codCasa;
  ...
  Future<void> _fetchData() async {
    ...
    if (selectedView == TemperatureViewType.day) {
      final dateKey = _formatDateKey(selectedDate);
      final snapshot = await rtdb.child("case/$codCasa/istoric_temperatura_interior/$dateKey").get();
      ...
      final int days = selectedView == TemperatureViewType.week
          ? 7
          : DateTime(selectedDate.year, selectedDate.month + 1, 0).day;
      final DateTime startDate = selectedView == TemperatureViewType.week
          ...
          titlesData: FlTitlesData(
            ...
            bottomTitles: AxisTitles(
              sideTitles: SideTitles(
                showTitles: true,
                interval: selectedView == TemperatureViewType.day ? 180 : 1,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    setState(() => selectedView = TemperatureViewType.day);
                    _fetchData();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedView == TemperatureViewType.day ? Colors.orange : Colors.grey,
                  ),
                  child: const Text("Zi"),
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() => selectedView = TemperatureViewType.week);
                    _fetchData();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedView == TemperatureViewType.week ? Colors.orange : Colors.grey,
                  ),
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() => selectedView = TemperatureViewType.month);
                    _fetchData();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedView == TemperatureViewType.month ? Colors.orange : Colors.grey,
                  ),
